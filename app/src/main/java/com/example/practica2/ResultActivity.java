...
public class ResultActivity extends AppCompatActivity {
    public static final String IMC_KEY = "masacorpal";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.setDataHeight(df.format(extras.getDouble(WEIGHT_KEY)));
        binding.setDataWeight(df.format(extras.getDouble(HEIGHT_KEY)));
